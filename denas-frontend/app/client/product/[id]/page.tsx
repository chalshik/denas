...
export default function ProductDetailsPage() {
  ...
  const availabilityColor = product.availability_type === 'IN_STOCK' 
    ? 'success' 
        ...
        <div className="space-y-6">
            ...
            {showPhoneNumber ? (
              <div className="flex items-center gap-2 p-4 bg-blue-50 rounded-lg">
                <div className="flex-1">
                  <p className="text-sm text-gray-600">Call this number to complete your purchase:</p>
                  <div className="flex items-center gap-2 mt-1">
                    <a href="tel:0773160307" className="text-lg font-semibold hover:underline">
                      0773160307
                    </a>
                    <Button 
                      size="sm" 
          ...
          {product.availability_type === 'PRE_ORDER' && (
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              <h4 className="font-medium text-yellow-800 mb-1">Pre-Order Information</h4>
              <p className="text-sm text-yellow-700">
                This item is available for pre-order. 
                {product.preorder_available_date && (
                  <span> Expected availability: {new Date(product.preorder_available_date).toLocaleDateString()}</span>
                )}
              </p>
            </div>
          )}
